...
class RoundData: ObservableObject {
    @Published var rounds: [DataModel] = [
            ...
            DataModel(date: createDate(year: 2024, month: 10, day: 19), score: 14, course: "Leksands GK", strokes: 110, image: "leksandgk", scores: [1: "4", 2: "5", 3: "3"]),
            DataModel(date: createDate(year: 2024, month: 10, day: 25), score: 14, course: "Leksands GK", strokes: 95, image: "leksandgk", scores: [1: "4", 2: "5", 3: "3"]),
            DataModel(date: createDate(year: 2024, month: 11, day: 15), score: 17, course: "Lidingö GK", strokes: 88, image: "lgk", scores: [1: "4", 2: "5", 3: "3"])
        ]
